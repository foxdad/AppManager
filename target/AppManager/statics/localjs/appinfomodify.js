...
function delfile(id){
	$.ajax({
		type:"GET",//请求类型
        url:"/app/delfile/"+id+'-'+'logo',//请求的url
...
$(function(){
	$.ajax({
		type:"GET",//请求类型
		url:"/app/queryCategoryLevel3",//请求的url
		//data:{pid:null},//请求参数
		dataType:"json",//ajax接口（请求url）返回的数据类型
		success:function(data){//data：返回数据（json对象）
			// console.log(data);
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/app/queryCategoryLevel1/"+categoryLevel1,//请求的url
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/app/queryCategoryLevel1/"+categoryLevel2,//请求的url
