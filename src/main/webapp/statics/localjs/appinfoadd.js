$(function(){
	...
	$.ajax({
		type:"GET",//请求类型
		url:"queryCategoryLevel3",//请求的url
		//data:{pid:null},//请求参数
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"queryCategoryLevel1/"+categoryLevel1,//请求的url
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"queryCategoryLevel1/"+categoryLevel2,//请求的url
	...
	$("#APKName").bind("blur",function(){
		...
		$.ajax({
			type:"GET",//请求类型
			url:"getApkName2/"+$("#APKName").val(),//请求的url
			// data:{APKName:$("#APKName").val()},//请求参数
			dataType:"json",//ajax接口（请求url）返回的数据类型
			success:function(data){//data：返回数据（json对象）
				if(data== null){//账号不可用，错误提示
					alert("该APKName可以使用！");
