...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 信息管理维护 <i class="fa fa-user"></i><small>${userSession.devName}
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu" role="menu">
														...
														<li><a class="addVersion" appinfoid="${appInfo.id }"
															data-toggle="tooltip" data-placement="top" title=""
															data-original-title="新增APP版本信息" href="/app/appversionAdd/${appInfo.id}">新增版本</a></li>
														...
														<li><a class="modifyAppInfo"
															...
															statusname="${appInfo.statusName }" data-toggle="tooltip"
															data-placement="top" title=""
															data-original-title="修改APP基础信息" href="/app/modify/${appInfo.id }">修改</a></li>
														<li><a class="viewApp" appinfoid=${appInfo.id }
															data-toggle="tooltip" data-placement="top" title=""
															data-original-title="查看APP基础信息以及全部版本信息" href="/app/viewapp/${appInfo.id }">查看</a></li>
