...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP基础信息 <i class="fa fa-user"></i><small>${userSession.devName}</small></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="/app/appmodifyInfosave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div id="logoFile"></div>
<%--                <img src="/statics/uploadfiles/com.google.android.inputmethod.pinyin.jpg"/>--%>
				${fileUploadError }
            </div>
          </div>
          <div class="form-group">
